...
//         var table = $(this);
//         $.ajax({
//           url: "liste_t", // URL de votre vue Django
//           type: 'GET',
...
//       var homeContent = $('.bx');
//       $.ajax({
//         url: "liste_t", // Utilisation de la syntaxe Django pour spécifier l'URL
//         type: 'GET',
//         success: function(data) {
...
$(document).ready(function() {
    ...
    function reloadTableContent() {
        $.ajax({
            url: 'liste_t', // URL de votre vue Django pour récupérer les données du tableau
            type: 'GET',
            success: function(data) {
